...
const defaultOptions = {
  ...
  debuggerSrc: {
    value: baseUrl + "js/lib/debugger.mjs",
  ...
  standardFontDataUrl: {
    value: baseUrl + "pdf/standard_fonts/",
    kind: OptionKind.API
  },
  verbosity: {
    value: 1,
  ...
  workerSrc: {
    value: baseUrl + "js/lib/pdf.worker.mjs",
    kind: OptionKind.WORKER
  }
};
{
  defaultOptions.defaultUrl = {
    value: baseUrl + "assets/resume-current.pdf",
    kind: OptionKind.VIEWER
  };
  defaultOptions.sandboxBundleSrc = {
      value: baseUrl + "js/lib/pdf.sandbox.mjs",
    kind: OptionKind.VIEWER
  };
